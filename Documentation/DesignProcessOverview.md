...
| **Yanjie Bu** | Team Leader & Interaction Designer | Led project planning, task allocation, and quality control. Conducted background research and literature review, designed interview questions, and collected user data. Created user personas, analyzed interview findings, and defined core design concepts. Produced low-fidelity prototypes and built digital versions of the home and detail pages. Participated in paper prototyping, user testing, and served as one of the main presenters at the trade show. |
